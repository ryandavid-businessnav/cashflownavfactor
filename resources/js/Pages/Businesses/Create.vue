    ...
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="store">
        ...
        <div class="flex items-center justify-end px-8 py-4 bg-gray-50 border-t border-gray-100">
          <loading-button :loading="form.processing" class="btn-custom-cfn" type="submit">Create Business</loading-button>
        </div>
      </form>
    </div>
  </div>
...
export default {
  ...
  methods: {
    store() {
      this.form.trading_name = this.form.company_name
      this.form.brand_name = this.form.company_name
      this.form.post('/businesses')
    },
  },
}
</script>
