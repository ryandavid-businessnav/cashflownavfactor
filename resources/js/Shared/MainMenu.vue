<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/businesses">
        <icon name="office" class="mr-2 w-4 h-4" :class="isUrl('businesses') ? 'fill-white' : 'fill-white group-hover:fill-white'" />
        <div :class="isUrl('businesses') ? 'text-white' : 'text-white group-hover:text-white'">Businesses</div>
      </Link>
    </div>
  </div>
</template>
