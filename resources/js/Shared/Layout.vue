    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:flex-shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-white-900 md:flex-shrink-0 md:justify-center md:w-56">
          ...
          <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white-900 border-b md:px-12 md:py-0">
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
          <main-menu class="hidden flex-shrink-0 p-12 w-56 bg-custom-cfn overflow-y-auto md:block" />
